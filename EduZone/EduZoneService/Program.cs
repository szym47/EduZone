using EduZone.Application.Service;
...
namespace EduZoneService;
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IEduZoneSeeder, EduZoneSeeder>();
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                var seeder = scope.ServiceProvider.GetRequiredService<IEduZoneSeeder>();
                await seeder.Seed();
            }
